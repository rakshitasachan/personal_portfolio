		...
		<div class="container">
			<div class="row">
				<div class="col-lg-5 content-photo">
					<a href="#"><img src="assets/images/img5.jpg" class="img-fluid" alt="content-photo" ></a>
				</div>
				<div class="col-lg-7 content-left mt-lg-0 mt-5 pl-lg-5">
					<h3>Success isn’t Always about Greatness. It’s about Consistency</h3>
					<p class="mb-0">I am Rakshita Sachan , a computer science engineer . I am a fresher in web development feild and I am workoing hard to be a great web developer in future. I thoroughly enjoy getting to create my personal projects like some of websites by using my skilled technologies.
            Beside all this I love to write quotes on my free time for my personal intrest.  </p>
  ...
  <div class="main-host py-5 text-center">
    <div class="container py-lg-3">
      <div class="grids-forms">
        ...
        <div class="main-midd">
          <h3 class="global-title mx-auto">The future belongs to those who believe in the beauty of their dreams.</h3>
        </div>
